...
public class FPSController : MonoBehaviour
{
    ...
    public static FPSController instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = GameObject.FindObjectOfType<FPSController>();
                if (_instance == null)
                {
                    GameObject fpsControllerObject = new GameObject("FPSController");
                    _instance = fpsControllerObject.AddComponent<FPSController>();
                }
            }
            return _instance;
        }
